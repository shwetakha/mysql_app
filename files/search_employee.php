...
<tr>
<td>Emp ID:</td>
<td><input type="text" name="Emp_id" value="<?= isset($_POST['Emp_id']) ? htmlspecialchars($_POST['Emp_id']) : '' ?>" size="30" required></td>
</tr>
...
$sql = "select Fname,Lname from emp_detail where Emp_id=$id";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
?>
<label style="color: red;">Employee Name is:</label><br><br>
<table style="border: 2px;border-color: black;width:400px;">
<tr><th>Emp ID</th><th></th><th>Employee Name</th></tr>
<?php 
	while($row = $result->fetch_assoc()) {
?>
	<tr><td align="center"><?php echo $id;?></td><td align="center"> => </td><td align="center"><?php 	echo  $row["Fname"]. " " .$row["Lname"];?></td></tr>
<?php 	
	}
}  
else {
