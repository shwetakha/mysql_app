...
$sql = "select distinct Lname from emp_detail";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
?>
<label style="color: red;">Employee's Last Names are:</label><br><br>
<table style="border: 2px;border-color: black;width:200px;">
<?php 
